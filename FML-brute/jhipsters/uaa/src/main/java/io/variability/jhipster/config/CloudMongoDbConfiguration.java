...
import io.variability.jhipster.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("io.variability.jhipster.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("io.variability.jhipster.config.dbmigrations");
