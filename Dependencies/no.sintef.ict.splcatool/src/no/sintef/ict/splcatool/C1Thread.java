...
class C1Thread implements Runnable, ProgressReporter{
	private CNF cnf;
	...
	public C1Thread(CNF cnf, List<Pair> uncovered, Integer sizelimit){
		this.cnf = cnf;
	...
	private void cover() {
		while(!uncovered.isEmpty()){
			...
			List<Integer> solution = setAndSolveMax(uncovered, covered);
