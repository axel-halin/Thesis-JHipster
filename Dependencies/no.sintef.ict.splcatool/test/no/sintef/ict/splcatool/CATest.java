...
public class CATest {
	...
	@Test
	public void testLoadPFCA() throws IOException, CSVException{
		CoveringArrayFile caf = new CoveringArrayFile("TestData/Artificial/TestCSVs/car_fm.xml.ca2.pf.csv");
		
		caf.writeToFile("test.dat", CoveringArrayFile.Type.vertical);
		
		String a = new FileUtility().readFileAsString("TestData/Artificial/TestCSVs/car_fm.xml.ca2.pf.csv");
		String b = new FileUtility().readFileAsString("test.dat");
