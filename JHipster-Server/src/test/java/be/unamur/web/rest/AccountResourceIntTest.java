...
import be.unamur.JhipsterServerApp;
import be.unamur.domain.Authority;
import be.unamur.domain.User;
import be.unamur.repository.AuthorityRepository;
import be.unamur.repository.UserRepository;
import be.unamur.security.AuthoritiesConstants;
